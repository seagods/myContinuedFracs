...
//Inspect values using ShowVerbose() (to std out) or PrintFracVerbose() to file test1.dat
     ...
     mpf_class floaty1, floaty2, floaty3, floatyX, fperr;
     ...
     for(int kount=0; kount<10000; kount++){
         ...
         if(Ransign>0.5){sgn=true;} else {sgn=false;}
          ...
          cout << "*****************   Frac1   ******************************\n";
          Frac1.Show();  floaty1= Frac1.ExtractFloat();
          cout << "*****************   Frac2   ******************************\n";
          Frac2.Show();  floaty2= Frac2.ExtractFloat();
          cout << "*****************   Frac2   ******************************\n";
          cout <<"Division Number " << kount << endl;
          ...
          if( Frac2.NotZero() ){
            ...
            Frac3.Show();  
            cout << "*****************  Sum   ******************************\n";
            cout <<  floaty1 << "  / " << floaty2 << "  = " << floaty3  << endl; 
            fperr=floaty1/floaty2-floaty3;
            if(abs(fperr)>eps){
              cout <<"kount=" << kount << endl;
              cout << "Error = " <<fperr << "  eps=" << eps  << endl;
              exit(1);  }
            cout << "*****************  Next  ******************************\n";
         } // end if Frac2!=0
      ...
      cout <<"RANtest3 competed without error!\n";
